...
<div class="d-flex flex-column gap-4" style="max-width: 700px;">
    ...
    <div class="card-custom p-4 bg-white">
        ...
        <form action="{{ route('kriteria.update', $kriteria) }}" method="POST">
            ...
            <div class="mb-3">
                <label for="nama" class="form-label fw-semibold text-dark">Nama Kriteria</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="sifat" class="form-label fw-semibold text-dark">Sifat (Atribut)</label>
                ...
                <div class="col-md-6">
                    <label for="bobot" class="form-label fw-semibold text-dark">Bobot Relatif (W)</label>
                    <div class="input-group">
                        ...
                        <span class="input-group-text bg-light text-muted">0 - 1</span>
                    </div>
            ...
            <div class="mb-3">
                <label for="satuan" class="form-label fw-semibold text-dark">Satuan Pengukuran</label>
